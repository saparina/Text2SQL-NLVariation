...
for dataset_for_eval in ${dr_spider_dataset_for_eval[@]}; do
    ...
    output="./predictions/${dataset_for_eval}/resdsql_3b_natsql_augs/pred_${dataset_for_eval}_post.sql"
    ...
    input_dataset_path="../data/diagnostic-robustness-text-to-sql/data/${dataset_for_eval}/questions_post_perturbation.json"

    case $dataset_for_eval in "DB_DBcontent_equivalence"|"DB_schema_abbreviation"|"DB_schema_synonym")
            table_path="../data/diagnostic-robustness-text-to-sql/data/${dataset_for_eval}/tables_post_perturbation.json"
            db_path="../data/diagnostic-robustness-text-to-sql/data/${dataset_for_eval}/database_post_perturbation"
    esac
