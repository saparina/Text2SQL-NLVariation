...
class DataArguments:
    ...
    predict_and_eval: bool = field(
        default=True,
        metadata={"help": "Do evaluation after predictions or not."},
    )
    ...
    test_suite_db_dir: Optional[str] = field(
        default="./third_party/test_suite/database",
    ...
    file_prefix: Optional[str] = field(
        default=None,
        metadata={"help": "File prefix for dataset files."})
